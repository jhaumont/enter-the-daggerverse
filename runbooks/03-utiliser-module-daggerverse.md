...
> [!NOTE]
> Il est aussi possible d'utiliser des modules non disponibles dans le Daggerverse. Plus d'informations dans cette [doc](https://docs.dagger.io/api/remote-modules).
